// NOTE(ChrisRx): This file was copied from golang.org/x/tools/internal/diffp
// along with some small changes in the output that are tailored towards how it
// is used in go.chrisrx.dev/x/assert.
