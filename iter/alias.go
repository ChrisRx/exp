...
//
// This is an alias of https://pkg.go.dev/iter#Seq.
...
// See the [iter] package documentation for more details.
//
// This is an alias of https://pkg.go.dev/iter#Seq2.
...
//
// This is an alias of https://pkg.go.dev/iter#Pull.
func Pull[V any](seq Seq[V]) (next func() (V, bool), stop func()) {
	return iter.Pull[V](seq)
}
...
// then next (or stop) itself panics with the same value.
//
// This is an alias of https://pkg.go.dev/iter#Pull2.
func Pull2[K, V any](seq Seq2[K, V]) (next func() (K, V, bool), stop func()) {
	return iter.Pull2[K, V](seq)
}
